		...
		<%
			...
			if(error!=null){
				if(error.equals("NoAccount")){
					out.print("<script> alert('您的登录名或密码错误！'); window.location='login.jsp'; </script>");//
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- Start Sign In Form -->
					<form action="LoginServletTest" class="fh5co-form animate-box" data-animate-effect="fadeIn" method="post">
						<h2>登录</h2>
